...
export const Route = createFileRoute("/team/researchers")({
  head: () => ({
    meta: [{ title: "Researchers | META4" }],
  }),
...
const researchersData = [
  {
    ...
    subtitle: "Meet the researchers of Meta4.",
    members: [
      {
        name: "",
        title: "",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="relative w-full h-48 md:h-64 flex items-center overflow-hidden border-b border-border">
        ...
        <img 
          src={heroBg} 
          alt="Researchers Header Background" 
      ...
      <main className="flex-1 py-16 md:py-24">
        <div className="mx-auto max-w-5xl px-6">
          ...
          {researchersData.map((section, index) => (
