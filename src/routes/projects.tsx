              ...
              {navItems.map((item) => (
                <li key={item.path}>
                  <Link
                    ...
                    className="flex items-center justify-between py-3 text-base font-medium text-foreground/90 hover:text-primary border-b border-border/60 last:border-0 transition-colors [&.active]:text-primary [&.active]:font-bold"
                  >
                    {item.name}
